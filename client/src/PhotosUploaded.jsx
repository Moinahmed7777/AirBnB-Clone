...
export default function PhotosUploader({addedPhotos, onChange}){
    ...
    async function addPhotoByLink(ev){
        ...
        //arrow function with previous value(array), return a new array with(added) filename element(append)
        onChange(prev =>{
    ...
    function uploadPhoto(ev) {
        ...
        axios.post('/upload',data, {
            ...
            //rename data to filename to add in addedphotos
        ...
        <>
            <div className="flex gap-2">
                <input value={photolink} 
                    ...
                    type='text'  placeholder={'Add photos using a link ... jpg'} />
